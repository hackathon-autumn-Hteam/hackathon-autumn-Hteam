...
(21, 'お疲れさま。この時間から勉強を始めるなんてすごいよ'),
(21, '一日の終わりに自分のための時間をつくれるって素敵'),
(21, '静かな夜は集中するのにちょうどいいね'),
(21, '今日も自分を少し育ててみよう'),
(21, '無理せず、でも諦めず。ゆっくり続けよう'),
(21, '心を落ち着けて、学びに向き合う時間にしよう'),
(21, '一歩だけでも進めば、それは確かな成長だね'),
(21, '夜の静けさがあなたの集中を支えてくれる'),
(21, '小さな気づきが、明日の力になる'),
(21, '今日の自分に「よくやってるよ」って言ってあげよう'),
(21, '少し疲れていても、始めた瞬間にスイッチが入るよ'),
(21, 'やさしい気持ちで、今日の学びを迎えよう'),
(21, 'この時間の努力が、明日の自分をつくる'),
(21, '寝る前の少しの学びが、明日へのいい流れをつくってくれる')
(21, '夜風を感じながら、静かに集中しよう'),
(21, '今日もここから、もう少しだけ頑張ってみよう'),
(21, '周りが休んでいる時間に積み上げるのは特別だね'),
(21, '焦らなくていい。自分のペースで大丈夫'),
(21, '一日の終わりに、穏やかに学びを楽しもう'),
(21, '夜のひとときに、心をゆるめながら前へ進もう');

(22, 'お疲れさま。こんな時間に勉強するなんて本当にすごいね'),
(22, '遅い時間でも、自分を高めようとする姿勢が輝いてる'),
(22, '今日の最後に、少しだけ未来に近づこう'),
(22, '静かな夜が、学びを優しく包んでくれる'),
(22, '小さな一歩が、確かな自信に変わっていく'),
(22, '無理せず、自分のペースでゆったりと進もう'),
(22, '夜は考えが整理されやすい時間だね'),
(22, '一日の終わりに、心を整えて知識を積み重ねよう'),
(22, '頑張るあなたを、未来の自分がきっと喜んでくれる'),
(22, '遅い時間の努力が、明日のあなたを支えてくれる'),
(22, '疲れた心に、少しの学びがやさしく灯をともす'),
(22, '焦らなくていい。今日できることを大切に'),
(22, '今日も「やろう」と思えたその気持ちが素晴らしい'),
(22, '静かな夜に、自分の成長を感じながら学ぼう'),
(22, '一日の締めくくりに、自分を褒める時間を持とう'),
(22, '眠る前に心を整えるように、穏やかに学ぼう'),
(22, 'この時間の学びが、心の安らぎになる'),
(22, '一日の中で一番落ち着く時間に、静かに知識を重ねよう'),
(22, '頑張るあなたに、夜空もきっと微笑んでる'),
(22, '一日の終わりに、未来に少しだけ手を伸ばしてみよう');
